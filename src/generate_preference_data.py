...
def main(task, num_return_sequences, prompt_len, sequence_len, batch_size):
    ...
    for batch in dataloader:
        ...
        rewards_by_prompt = [list(map(lambda c: reward_func(prompt, c), completions)) for prompt, completions in zip(prompts, completions_by_prompt)]
...
if __name__ == "__main__":
    ...
    main(args.task, args.num_return_sequences, args.prompt_len, args.sequence_len, args.batch_size)
